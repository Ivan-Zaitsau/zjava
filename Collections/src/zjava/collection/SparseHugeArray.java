 ...
 * @author Ivan Zaitsau
 */
public class SparseHugeArray<E> implements HugeArray<E>, Cloneable, java.io.Serializable {
     ...
     */
	@SuppressWarnings("unchecked")
	public SparseHugeArray(long size) {
        if (size < 0)
	...
	public Object clone() {
		try {
			@SuppressWarnings("unchecked")
			SparseHugeArray<E> clone = (SparseHugeArray<E>) super.clone();
